...
class _DashboardPageState extends State<DashboardPage> {
  List<productdata> _produklist = [
    productdata(
      ...
      price: 49.00,
      img: 'assets/image/caminimint.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'assets/image/caminiblue.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'assets/image/caminichoral.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'assets/image/caminipink.png',
    ...
    productdata(
      ...
      price: 48.00,
      img: 'assets/image/caminilavender.png',
